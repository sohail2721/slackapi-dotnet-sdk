// <copyright file="AdminTeamsAdminsController.cs" company="APIMatic">
...
namespace SlackWebApi.Standard.Controllers
{
    ...
    /// </summary>
    public class AdminTeamsAdminsController : BaseController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdminTeamsAdminsController"/> class.
        /// </summary>
        internal AdminTeamsAdminsController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        public ApiResponse<Models.DefaultSuccessTemplate> AdminTeamsAdminsList(
                string token,
                string teamId,
                int? limit = null,
                string cursor = null)
            => CoreHelper.RunTask(AdminTeamsAdminsListAsync(token, teamId, limit, cursor));
        ...
        /// <returns>Returns the ApiResponse of Models.DefaultSuccessTemplate response from the API call.</returns>
        public async Task<ApiResponse<Models.DefaultSuccessTemplate>> AdminTeamsAdminsListAsync(
                string token,
                string teamId,
                int? limit = null,
                string cursor = null,
            ...
            => await CreateApiCall<Models.DefaultSuccessTemplate>()
              .RequestBuilder(requestBuilder => requestBuilder
                  .Setup(HttpMethod.Get, "/admin.teams.admins.list")
                  .WithAuth("slackAuth")
